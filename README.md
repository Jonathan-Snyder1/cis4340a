...
- I added the 5 mandatory vulnerabilites in the sequence of adding the non compliant one then creating an edit branch where i made the fixs to make it compliant. I didn't merge the edits with the master branch as per assignment instructions. Also in addition I added in imports for some of the code not sure if that was necessary or not.
- I repeated the same process for 5 other java rules
